...
const countries: Country[] = [
    { code: 'BR', name: 'Brasil', dialCode: '+55', flag: '🇧🇷', placeholder: '(11) 99999-9999', maxLength: 16 },
    { code: 'AR', name: 'Argentina', dialCode: '+54', flag: '🇦🇷', placeholder: '11 2345-6789', maxLength: 15 },
    { code: 'PY', name: 'Paraguai', dialCode: '+595', flag: '🇵🇾', placeholder: '0981 123456', maxLength: 15 },
    { code: 'UY', name: 'Uruguai', dialCode: '+598', flag: '🇺🇾', placeholder: '099 123 456', maxLength: 15 },
    { code: 'CL', name: 'Chile', dialCode: '+56', flag: '🇨🇱', placeholder: '9 1234 5678', maxLength: 15 },
    { code: 'US', name: 'Estados Unidos', dialCode: '+1', flag: '🇺🇸', placeholder: '(201) 555-0123', maxLength: 16 },
    { code: 'PT', name: 'Portugal', dialCode: '+351', flag: '🇵🇹', placeholder: '912 345 678', maxLength: 15 },
    { code: 'ES', name: 'Espanha', dialCode: '+34', flag: '🇪🇸', placeholder: '612 34 56 78', maxLength: 15 },
];
    ...
    <div class="flex w-full gap-2">
        <div ref="dropdownRef" class="relative shrink-0">
            <button
                ...
                class="border-input flex h-9 items-center gap-1.5 rounded-md border bg-transparent px-2.5 text-sm shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 dark:bg-input/30"
                @click="open = !open"
            >
                <span class="text-base leading-none">{{ selected.flag }}</span>
                <span class="text-muted-foreground font-medium">{{ selected.dialCode }}</span>
                <ChevronDownIcon
            ...
            <ul
                v-show="open"
                role="listbox"
                class="bg-popover text-popover-foreground absolute left-0 z-50 mt-1 max-h-64 w-56 overflow-y-auto rounded-md border py-1 shadow-md"
            >
                <li
                ...
                >
                    ...
                    <span class="text-muted-foreground ml-auto font-mono text-xs">{{ country.dialCode }}</span>
                </li>
            </ul>
        </div>
