...
export type TransactionScale = 'day' | 'week' | 'month';

export type TransactionFilters = {
    scale: TransactionScale;
    /** The day the visible stretch is measured from; the arrows move this. */
    date: string;
    from: string;
    to: string;
    /** True once the drawer's own dates decide the stretch, retiring the scale. */
