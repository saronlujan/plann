...
return [
    ...
    'filters' => [
        'title' => 'Filters',
        'description' => 'Narrow the list. Picking two dates replaces the period.',
        'more' => 'Filters',
        'search' => 'Search',
        'search_placeholder' => 'Description, note or account',
        ...
        'status' => 'Status',
        'status_paid' => 'Settled',
        'status_pending' => 'Outstanding',
        'order' => 'Sort by',
        'order_date_desc' => 'Date (newest)',
        'order_date_asc' => 'Date (oldest)',
        'order_amount_desc' => 'Amount (highest)',
        'order_amount_asc' => 'Amount (lowest)',
        'from' => 'From',
        'to' => 'To',
        'range_hint' => 'Fill both dates to use a range of your own.',
        'range' => 'Custom range',
