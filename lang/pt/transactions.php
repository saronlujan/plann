...
return [
    ...
    'filters' => [
        'title' => 'Filtros',
        'description' => 'Refine a lista. Escolher duas datas substitui o período.',
        'more' => 'Filtros',
        'search' => 'Buscar',
        'search_placeholder' => 'Descrição, nota ou conta',
        ...
        'order' => 'Ordenar por',
        'order_date_desc' => 'Data (mais recente)',
        'order_date_asc' => 'Data (mais antiga)',
        'order_amount_desc' => 'Valor (maior)',
        'order_amount_asc' => 'Valor (menor)',
        'from' => 'De',
        'to' => 'Até',
        'range_hint' => 'Preencha as duas datas para usar um intervalo próprio.',
