...
return [
    ...
    */
    ...
    'base64' => 'El campo :attribute debe ser un Base64 válido.',
    ...
    */
    ...
    'label_color' => 'El color debe ser de la paleta o un hexadecimal como #6361f3.',

    'custom' => [
        'destination_account_id' => [
            'different' => 'La cuenta de destino debe ser diferente de la cuenta de origen.',
        ],
        'pin' => [
            'digits' => 'El código debe tener 6 dígitos.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'adjustment_month' => 'mes del ajuste',
        'amount' => 'importe',
        'attachment' => 'adjunto',
        'balance' => 'saldo',
        ...
        'currency_id' => 'moneda',
        'currency_ids' => 'monedas',
        'current_password' => 'contraseña actual',
        'description' => 'descripción',
        'destination_account_id' => 'cuenta de destino',
        'document' => 'documento',
        'due_day' => 'día de vencimiento',
        'effective_date' => 'fecha',
        'effective_until' => 'fecha final',
        'email' => 'correo electrónico',
        'installment_frequency' => 'frecuencia de las cuotas',
        ...
        'notify_days_before' => 'días de antelación',
        'occurrence_date' => 'fecha de la ocurrencia',
        'password' => 'contraseña',
        'password_confirmation' => 'confirmación de la contraseña',
        'phone' => 'teléfono',
        'pin' => 'código',
        'recurrence_scope' => 'alcance de la recurrencia',
        'remember' => 'mantener sesión',
        'sound_enabled' => 'sonidos',
        'sound_theme' => 'tema de sonido',
        'tags' => 'etiquetas',
        'theme' => 'tema',
        'type' => 'tipo',
    ],
